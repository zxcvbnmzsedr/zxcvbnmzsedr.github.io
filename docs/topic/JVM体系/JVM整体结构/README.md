...
![JVM基本结构](./assets/20220815221833.png "JVM基本结构")​
...
![](./assets/20220816101610.png)​

# 内存参数设置

JVM提供了一系列参数来对各个部分的大小进行控制：

![](./assets/20220816133234.png)​
